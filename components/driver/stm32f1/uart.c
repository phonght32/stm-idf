...
#define UART1_PP1_HW_INFO   {.rcc_apbenr_gpioen_tx = RCC_APB2ENR_IOPAEN,    \
                             .rcc_apbenr_gpioen_rx = RCC_APB2ENR_IOPAEN,    \
                             .port_tx = GPIOA,                              \
                             .port_rx = GPIOA,                              \
                             .pin_tx = GPIO_PIN_9,                          \
                             .pin_rx = GPIO_PIN_10}

#define UART1_PP2_HW_INFO   {.rcc_apbenr_gpioen_tx = RCC_APB2ENR_IOPBEN,    \
                             .rcc_apbenr_gpioen_rx = RCC_APB2ENR_IOPBEN,    \
                             .port_tx = GPIOB,                              \
                             .port_rx = GPIOB,                              \
                             .pin_tx = GPIO_PIN_6,                          \
                             .pin_rx = GPIO_PIN_7}

#define UART2_PP1_HW_INFO   {.rcc_apbenr_gpioen_tx = RCC_APB2ENR_IOPAEN,    \
                             .rcc_apbenr_gpioen_rx = RCC_APB2ENR_IOPAEN,    \
                             .port_tx = GPIOA,                              \
                             .port_rx = GPIOA,                              \
                             .pin_tx = GPIO_PIN_2,                          \
...
#define UART2_PP2_HW_INFO   {.rcc_apbenr_gpioen_tx = RCC_APB2ENR_IOPDEN,    \
                             .rcc_apbenr_gpioen_rx = RCC_APB2ENR_IOPDEN,    \
                             .port_tx = GPIOD,                              \
                             .port_rx = GPIOD,                              \
                             .pin_tx = GPIO_PIN_5,                          \
                             .pin_rx = GPIO_PIN_6}

#define UART3_PP1_HW_INFO   {.rcc_apbenr_gpioen_tx = RCC_APB2ENR_IOPBEN,    \
                             .rcc_apbenr_gpioen_rx = RCC_APB2ENR_IOPBEN,    \
                             .port_tx = GPIOB,                              \
                             .port_rx = GPIOB,                              \
                             .pin_tx = GPIO_PIN_10,                         \
...
#define UART3_PP2_HW_INFO   {.rcc_apbenr_gpioen_tx = RCC_APB2ENR_IOPCEN,    \
                             .rcc_apbenr_gpioen_rx = RCC_APB2ENR_IOPCEN,    \
                             .port_tx = GPIOC,                              \
                             .port_rx = GPIOC,                              \
                             .pin_tx = GPIO_PIN_10,                         \
                             .pin_rx = GPIO_PIN_11}

#define UART3_PP3_HW_INFO   {.rcc_apbenr_gpioen_tx = RCC_APB2ENR_IOPDEN,    \
                             .rcc_apbenr_gpioen_rx = RCC_APB2ENR_IOPDEN,    \
                             .port_tx = GPIOD,                              \
                             .port_rx = GPIOD,                              \
                             .pin_tx = GPIO_PIN_8,                          \
...
#define UART4_PP1_HW_INFO   {.rcc_apbenr_gpioen_tx = RCC_APB2ENR_IOPAEN,    \
                             .rcc_apbenr_gpioen_rx = RCC_APB2ENR_IOPAEN,    \
                             .port_tx = GPIOA,                              \
                             .port_rx = GPIOA,                              \
                             .pin_tx = GPIO_PIN_0,                          \
...
#define UART4_PP2_HW_INFO   {.rcc_apbenr_gpioen_tx = RCC_APB2ENR_IOPCEN,    \
                             .rcc_apbenr_gpioen_rx = RCC_APB2ENR_IOPCEN,    \
                             .port_tx = GPIOC,                              \
                             .port_rx = GPIOC,                              \
                             .pin_tx = GPIO_PIN_10,                         \
...
#define UART5_PP1_HW_INFO   {.rcc_apbenr_gpioen_tx = RCC_APB2ENR_IOPCEN,    \
                             .rcc_apbenr_gpioen_rx = RCC_APB2ENR_IOPDEN,    \
                             .port_tx = GPIOC,                              \
                             .port_rx = GPIOD,                              \
                             .pin_tx = GPIO_PIN_12,                         \
...
typedef struct {
    uint32_t       rcc_apbenr_gpioen_tx;    /*!< TX GPIO RCC AHPENR register */
    uint32_t       rcc_apbenr_gpioen_rx;    /*!< RX GPIO RCC AHPENR register */
...
static uint32_t UART_AFIO_REMAP_MAPPING[UART_NUM_MAX] = {
    AFIO_MAPR_USART1_REMAP,
    AFIO_MAPR_USART2_REMAP,
    AFIO_MAPR_USART3_REMAP,
    AFIO_MAPR_UART4_REMAP,
    AFIO_MAPR_UART5_REMAP,
};
...
stm_err_t uart_config(uart_config_t *config)
{
    ...
    tmpreg = 0x00;
    SET_BIT(RCC->APB2ENR,  hw_info.rcc_apbenr_gpioen_tx);
    tmpreg = READ_BIT(RCC->APB2ENR, hw_info.rcc_apbenr_gpioen_tx);
    UNUSED(tmpreg);

    /* Enable RX GPIO port clock */
    tmpreg = 0x00;
    SET_BIT(RCC->APB2ENR, hw_info.rcc_apbenr_gpioen_rx);
    tmpreg = READ_BIT(RCC->APB2ENR, hw_info.rcc_apbenr_gpioen_rx);
    UNUSED(tmpreg);
