...
#define UART1_PP1_HW_INFO   {.rcc_ahbenr_gpioen_tx = RCC_AHB2ENR_GPIOAEN,    \
                             .rcc_ahbenr_gpioen_rx = RCC_AHB2ENR_GPIOAEN,    \
                             .port_tx = GPIOA,                               \
                             .port_rx = GPIOA,                               \
                             .pin_tx = GPIO_PIN_9,                           \
                             .pin_rx = GPIO_PIN_10}

#define UART1_PP2_HW_INFO   {.rcc_ahbenr_gpioen_tx = RCC_AHB2ENR_GPIOBEN,    \
                             .rcc_ahbenr_gpioen_rx = RCC_AHB2ENR_GPIOBEN,    \
                             .port_tx = GPIOB,                               \
                             .port_rx = GPIOB,                               \
                             .pin_tx = GPIO_PIN_7,                           \
                             .pin_rx = GPIO_PIN_7}

#define UART2_PP1_HW_INFO   {.rcc_ahbenr_gpioen_tx = RCC_AHB2ENR_GPIOAEN,    \
                             .rcc_ahbenr_gpioen_rx = RCC_AHB2ENR_GPIOAEN,    \
                             .port_tx = GPIOA,                               \
                             .port_rx = GPIOA,                               \
                             .pin_tx = GPIO_PIN_2,                           \
...
#define UART2_PP2_HW_INFO   {.rcc_ahbenr_gpioen_tx = RCC_AHB2ENR_GPIODEN,    \
                             .rcc_ahbenr_gpioen_rx = RCC_AHB2ENR_GPIODEN,    \
                             .port_tx = GPIOD,                               \
                             .port_rx = GPIOD,                               \
                             .pin_tx = GPIO_PIN_5,                           \
                             .pin_rx = GPIO_PIN_6}

#define UART3_PP1_HW_INFO   {.rcc_ahbenr_gpioen_tx = RCC_AHB2ENR_GPIOBEN,    \
                             .rcc_ahbenr_gpioen_rx = RCC_AHB2ENR_GPIOBEN,    \
                             .port_tx = GPIOB,                               \
                             .port_rx = GPIOB,                               \
                             .pin_tx = GPIO_PIN_10,                          \
...
#define UART3_PP2_HW_INFO   {.rcc_ahbenr_gpioen_tx = RCC_AHB2ENR_GPIOCEN,    \
                             .rcc_ahbenr_gpioen_rx = RCC_AHB2ENR_GPIOCEN,    \
                             .port_tx = GPIOC,                               \
                             .port_rx = GPIOC,                               \
                             .pin_tx = GPIO_PIN_10,                          \
                             .pin_rx = GPIO_PIN_11}

#define UART3_PP3_HW_INFO   {.rcc_ahbenr_gpioen_tx = RCC_AHB2ENR_GPIODEN,    \
                             .rcc_ahbenr_gpioen_rx = RCC_AHB2ENR_GPIODEN,    \
                             .port_tx = GPIOD,                               \
                             .port_rx = GPIOD,                               \
                             .pin_tx = GPIO_PIN_8,                           \
...
#define UART4_PP1_HW_INFO   {.rcc_ahbenr_gpioen_tx = RCC_AHB2ENR_GPIOAEN,    \
                             .rcc_ahbenr_gpioen_rx = RCC_AHB2ENR_GPIOAEN,    \
                             .port_tx = GPIOA,                               \
                             .port_rx = GPIOA,                               \
                             .pin_tx = GPIO_PIN_0,                           \
...
#define UART4_PP2_HW_INFO   {.rcc_ahbenr_gpioen_tx = RCC_AHB2ENR_GPIOCEN,    \
                             .rcc_ahbenr_gpioen_rx = RCC_AHB2ENR_GPIOCEN,    \
                             .port_tx = GPIOC,                               \
                             .port_rx = GPIOC,                               \
                             .pin_tx = GPIO_PIN_10,                          \
...
#define UART5_PP1_HW_INFO   {.rcc_ahbenr_gpioen_tx = RCC_AHB2ENR_GPIOCEN,    \
                             .rcc_ahbenr_gpioen_rx = RCC_AHB2ENR_GPIODEN,    \
                             .port_tx = GPIOC,                               \
                             .port_rx = GPIOD,                               \
                             .pin_tx = GPIO_PIN_12,                          \
...
stm_err_t uart_config(uart_cfg_t *config)
{
    ...
    {
        SET_BIT(RCC->APB1ENR1, RCC_APBENR_UARTEN_MAPPING[config->uart_num]);
        tmpreg = READ_BIT(RCC->APB1ENR1, RCC_APBENR_UARTEN_MAPPING[config->uart_num]);
    }
    UNUSED(tmpreg);

    /* Enable TX GPIO port clock */
    tmpreg = 0x00;
    SET_BIT(RCC->AHB2ENR,  hw_info.rcc_ahbenr_gpioen_tx);
    tmpreg = READ_BIT(RCC->AHB2ENR, hw_info.rcc_ahbenr_gpioen_tx);
    UNUSED(tmpreg);

    /* Enable RX GPIO port clock */
    tmpreg = 0x00;
    SET_BIT(RCC->AHB2ENR, hw_info.rcc_ahbenr_gpioen_rx);
    tmpreg = READ_BIT(RCC->AHB2ENR, hw_info.rcc_ahbenr_gpioen_rx);
    UNUSED(tmpreg);
