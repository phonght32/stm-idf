...
#define I2C1_PP1_HW_INFO    {.rcc_ahbenr_gpio_scl = RCC_AHB2ENR_GPIOBEN,    \
                             .rcc_ahbenr_gpio_sda = RCC_AHB2ENR_GPIOBEN,    \
                             .port_scl = GPIOB,                             \
                             .port_sda = GPIOB,                             \
                             .pin_scl = GPIO_PIN_6,                         \
                             .pin_sda = GPIO_PIN_7}

#define I2C1_PP2_HW_INFO    {.rcc_ahbenr_gpio_scl = RCC_AHB2ENR_GPIOBEN,    \
                             .rcc_ahbenr_gpio_sda = RCC_AHB2ENR_GPIOBEN,    \
                             .port_scl = GPIOB,                             \
                             .port_sda = GPIOB,                             \
                             .pin_scl = GPIO_PIN_8,                         \
...
#define I2C1_PP3_HW_INFO    {.rcc_ahbenr_gpio_scl = RCC_AHB2ENR_GPIOBEN,    \
                             .rcc_ahbenr_gpio_sda = RCC_AHB2ENR_GPIOBEN,    \
                             .port_scl = GPIOB,                             \
                             .port_sda = GPIOB,                             \
                             .pin_scl = GPIO_PIN_6,                         \
...
#define I2C2_PP1_HW_INFO    {.rcc_ahbenr_gpio_scl = RCC_AHB2ENR_GPIOBEN,    \
                             .rcc_ahbenr_gpio_sda = RCC_AHB2ENR_GPIOBEN,    \
                             .port_scl = GPIOB,                             \
                             .port_sda = GPIOB,                             \
                             .pin_scl = GPIO_PIN_10,                        \
...
#define I2C2_PP2_HW_INFO    {.rcc_ahbenr_gpio_scl = RCC_AHB2ENR_GPIOFEN,    \
                             .rcc_ahbenr_gpio_sda = RCC_AHB2ENR_GPIOFEN,    \
                             .port_scl = GPIOF,                             \
                             .port_sda = GPIOF,                             \
                             .pin_scl = GPIO_PIN_1,                         \
                             .pin_sda = GPIO_PIN_0}

#define I2C2_PP3_HW_INFO    {.rcc_ahbenr_gpio_scl = RCC_AHB2ENR_GPIOHEN,    \
                             .rcc_ahbenr_gpio_sda = RCC_AHB2ENR_GPIOHEN,    \
                             .port_scl = GPIOH,                             \
                             .port_sda = GPIOH,                             \
                             .pin_scl = GPIO_PIN_4,                         \
                             .pin_sda = GPIO_PIN_5}

#define I2C3_PP1_HW_INFO    {.rcc_ahbenr_gpio_scl = RCC_AHB2ENR_GPIOAEN,    \
                             .rcc_ahbenr_gpio_sda = RCC_AHB2ENR_GPIOCEN,    \
                             .port_scl = GPIOA,                             \
                             .port_sda = GPIOC,                             \
                             .pin_scl = GPIO_PIN_8,                         \
                             .pin_sda = GPIO_PIN_9}

#define I2C3_PP2_HW_INFO    {.rcc_ahbenr_gpio_scl = RCC_AHB2ENR_GPIOHEN,    \
                             .rcc_ahbenr_gpio_sda = RCC_AHB2ENR_GPIOHEN,    \
                             .port_scl = GPIOH,                             \
                             .port_sda = GPIOH,                             \
                             .pin_scl = GPIO_PIN_7,                         \
...
uint32_t RCC_APBENR1_I2CEN_MAPPING[I2C_NUM_MAX] = {
    RCC_APB1ENR1_I2C1EN,
    RCC_APB1ENR1_I2C2EN,
    RCC_APB1ENR1_I2C3EN
};
...
stm_err_t i2c_config(i2c_cfg_t *config)
{
    ...
    SET_BIT(RCC->APB1ENR1, RCC_APBENR1_I2CEN_MAPPING[config->i2c_num]);
    tmpreg = READ_BIT(RCC->APB1ENR1, RCC_APBENR1_I2CEN_MAPPING[config->i2c_num]);
    UNUSED(tmpreg);

    /* Enable SCL GPIO Port clock */
    tmpreg = 0x00;
    SET_BIT(RCC->AHB2ENR, hw_info.rcc_ahbenr_gpio_scl);
    tmpreg = READ_BIT(RCC->AHB2ENR, hw_info.rcc_ahbenr_gpio_scl);
    UNUSED(tmpreg);

    /* Enable SDA GPIO Port clock */
    tmpreg = 0x00;
    SET_BIT(RCC->AHB2ENR, hw_info.rcc_ahbenr_gpio_sda);
    tmpreg = READ_BIT(RCC->AHB2ENR, hw_info.rcc_ahbenr_gpio_sda);
    UNUSED(tmpreg);
